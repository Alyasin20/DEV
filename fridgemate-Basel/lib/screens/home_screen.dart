...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Refresh recent items on returning from AddItemScreen
  Future<void> _navigateToAddItemScreen() async {
    final result = await Navigator.pushNamed(context, '/addItem');
    if (result == true) {
      setState(() {}); // Trigger a refresh to show the newly added item
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: itemList.isNotEmpty
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  final recentItem = itemList[itemList.length - 1 - index];
                  return Card(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: _navigateToAddItemScreen, // Call navigation function with refresh capability
        ...
        children: [
          ...
          _buildDrawerItem(Icons.shopping_cart, "My Items", () {
            ...
            Navigator.pushNamed(context, '/myItems').then((_) {
              setState(() {}); // Refresh home screen when returning from MyItemsScreen
            });
          }),
